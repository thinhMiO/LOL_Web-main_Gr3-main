...
<div class="controls">
<input type="password"  name="password" class="span8 tip" >
</div>
</div>
...
<div class="controls">
<input type="password"  name="newpassword" class="span8 tip" >
</div>
</div>
...
<div class="controls">
<input type="password"  name="confirmpassword" class="span8 tip" >
</div>
</div>
