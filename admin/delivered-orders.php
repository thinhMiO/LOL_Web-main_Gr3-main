...
<body id="body">
	...
	<table class="table mytable" border="1" align="center"   cellspacing="0" >
			...
			<tbody>
				<?php 
				$query=mysqli_query($con,"SELECT u.*,o.* from orders as o inner join users as u on o.userId = u.id where o.orderStatus =2  ORDER by o.orderDate DESC");
				$cnt=1;
				...
				<tr>
					...
					<td><?php echo htmlentities(date("H:i d-m-Y",strtotime($row['orderdelive'])));?></td>
					<td>    
