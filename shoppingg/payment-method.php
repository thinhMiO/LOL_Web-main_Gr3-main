...
<style>
	.selectt{
		...
		<br>
		 ...
		 <div class="ib selectt" id="box" style="font-size: 16px;">
                        Ngân hàng MBBank  <br>
                        Chủ tài khoản: NGUYEN CONG THINH<br> 
                        Số tài khoản: 688628022004 <br>
                        Nội dung: Họ & Tên + Số điện thoại</p>
						<img style="width: 20%; background-color: #666; margin-left: 400px; margin-top: -100px; " src="../shoppingg/img/QRPayment.jpg" alt="" >
                        </div>
		 <br>
	     <input type="radio"id="qr" name="paymethod" value="QR Payment"> VNPAY<br /><br />
		 
		 <!-- <div class="qr selectt" ><img style="width: 20%; background-color: #666;" src="../shoppingg/img/QRPayment.jpg" alt=""></div> -->
