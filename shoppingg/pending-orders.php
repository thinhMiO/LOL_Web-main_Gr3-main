		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total last-item">Xóa đơn hàng</th>
				</tr>
			</thead><!-- /thead -->
...
<?php
$query=mysqli_query($con,"SELECT * from orders where orders.userId ='".$_SESSION['id']."' and orders.paymentMethod is not null and orders.orderStatus=0 order by orders.orderDate DESC " );
$cnt = 0;
				...
				<tr>
					...
					<td>
						<form action="" method="get" id="delete" name="delete">
							<a href="../shoppingg/includes/trashorder.php?id=<?=$row['idorder']?>" onclick="return confirm('Chắc chắn xóa')"><i class="fa fa-trash" style="font-size: 24px;"></i></a>
						 </form>
