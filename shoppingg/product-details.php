...
?>
 ...
 <div class="single-product-gallery-item" id="slide1">
                <a data-lightbox="image-1" data-title="<?php echo htmlentities($row['productName']);?>" href="admin/productimages/<?php echo htmlentities($row['productImage1']);?>">
                    <img class="img-responsive" alt="" src="../shoppingg/assets/images/blank.gif" data-echo="../admin/productimages/<?php echo htmlentities($row['productImage1']);?>" width="370" height="350" />
                </a>
            </div>
            ...
            <div class="single-product-gallery-item" id="slide2">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['productImage2']);?>">
                    <img class="img-responsive" alt="" src="../shoppingg/assets/images/blank.gif" data-echo="../admin/productimages/<?php echo htmlentities($row['productImage2']);?>" />
                </a>
            </div><!-- /.single-product-gallery-item -->

            <div class="single-product-gallery-item" id="slide3">
                <a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['productImage3']);?>">
                    <img class="img-responsive" alt="" src="../shoppingg/assets/images/blank.gif" data-echo="../admin/productimages/<?php echo htmlentities($row['productImage3']);?>" />
                </a>
            </div>
            ...
            <div id="owl-single-product-thumbnails">
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide1">
                        <img class="img-responsive"  alt="" src="../shoppingg/assets/images/blank.gif" data-echo="../admin/productimages/<?php echo htmlentities($row['productImage1']);?>" />
                    </a>
                </div>

            <div class="item">
                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="2" href="#slide2">
                        <img class="img-responsive" width="85" alt="" src="../shoppingg/assets/images/blank.gif" data-echo="../admin/productimages/<?php echo htmlentities($row['productImage2']);?>"/>
                    </a>
                </div>
                <div class="item">

                    <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="3" href="#slide3">
                        <img class="img-responsive" width="85" alt="" src="../shoppingg/assets/images/blank.gif" data-echo="../admin/productimages/<?php echo htmlentities($row['productImage3']);?>" height="200" />
                    </a>
                </div>
...
<?php } ?>
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"> <?php echo number_format($row['productPrice'],0,',','.');?><sup>đ</sup></span>
							...
							<div class="quantity-container info-container">
								...
								<a href="product-details.php?product&action=add&pid=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i>Thêm Vào Giỏ Hàng</a>
													<?php } else {?>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				...
				<img  src="../shoppingg/assets/images/blank.gif" data-echo="../admin/productimages
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
				<?php echo number_format($rw['productPrice'],0,',','.');?><sup>đ</sup>		</span>
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?product&action=add&pid=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Thêm Vào Giỏ Hàng</a>
