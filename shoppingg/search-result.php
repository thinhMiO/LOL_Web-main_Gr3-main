					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active " id="grid-container">
							<div class="category-product  inner-top-vs">
								<div class="row">									
			<?php
$ret=mysqli_query($con,"SELECT p.*,c.* from  products as p inner join category as c on p.category=c.id where c.categoryname like '%$find%' or p.productName like '%$find%'");
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					 <?php echo number_format($row['productPrice'],0,',','.');?>			</span>
